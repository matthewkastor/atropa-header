...
This package lives at: [https://npmjs.org/package/atropa-header](https://npmjs.org/package/atropa-header)

Source code available at: [https://github.com/matthewkastor/atropa-header/](https://github.com/matthewkastor/atropa-header/)
...
In the browser this module is attached to the global namespace `atropa`, which
 ...
 Include `./browser/atropa-header_web.js` in your page and
...
To run the browser tests open `browser/atropa-header_tests.html` in your
...
If you alter the source in `src/atropa-header.js` please run the
